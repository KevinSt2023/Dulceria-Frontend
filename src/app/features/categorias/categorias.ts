  ...
  template: `
    <div>
      ...
      <div class="flex justify-between items-center mb-6">
        <h2 class="text-xl font-bold text-gray-700">Categorias</h2>
      ...
      <div class="overflow-x-auto" *ngIf="!loading">
        <table class="min-w-full bg-white rounded-xl overflow-hidden shadow">
          ...
          <tbody>
            <tr *ngFor="let p of categorias" class="border-t hover:bg-gray-50">
              <td class="p-3 text-center">{{ p.categoria_id }}</td>              
