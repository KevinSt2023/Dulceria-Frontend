  ...
  template: `
    <div>
      ...
      <div class="flex justify-between items-center mb-6">
        <h2 class="text-xl font-bold text-gray-700">Sucursales</h2>
      ...
      <div class="overflow-x-auto mb-6">
        <table class="min-w-full bg-white rounded-xl shadow">
          ...
          <tbody>
            <tr *ngFor="let p of sucursales" class="border-t hover:bg-gray-50">
              <td class="p-3 text-center">{{ p.sucursal_id }}</td>
              <td class="p-3 text-center">{{ p.nombre }}</td>
              <td class="p-3 max-w-sm">
                <p class="line-clamp-2 text-center">{{ p.direccion }}</p>
              </td>
      ...
      >
        <div class="bg-white rounded-xl shadow-xl w-full max-w-md p-6 animate-fade-in">
          <h3 class="text-lg font-bold mb-4">{{ editando ? 'Editar' : 'Nuevo' }} Sucursales</h3>
